...
export default function AttendanceIllustration({
  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 150 110">
      ...
      <Circle cx="35" cy="35" r="22" fill={isDarkMode ? '#1E293B' : '#dbeafe'} opacity="0.6" />
      <Circle cx="115" cy="75" r="18" fill={isDarkMode ? '#3730A3' : '#f5f3ff'} opacity="0.5" />

      {/* Shadow */}
      <Ellipse cx="75" cy="98" rx="50" ry="5" fill={isDarkMode ? '#818CF8' : '#6366f1'} opacity="0.08" />

      {/* === Calendar (background-left) === */}
      <G transform="translate(25, 30)" opacity="0.85">
        <Rect x="0" y="0" width="32" height="34" rx="6" fill={isDarkMode ? '#1E293B' : '#ffffff'} stroke={isDarkMode ? '#334155' : '#e2e8f0'} strokeWidth="1.5" />
        ...
        {/* Calendar lines */}
        <Rect x="6" y="16" width="6" height="4" rx="1.5" fill={isDarkMode ? '#334155' : '#e2e8f0'} />
        <Rect x="18" y="16" width="8" height="4" rx="1.5" fill={isDarkMode ? '#334155' : '#e2e8f0'} />
        <Rect x="6" y="24" width="8" height="4" rx="1.5" fill={isDarkMode ? '#334155' : '#e2e8f0'} />
        <Rect x="20" y="24" width="6" height="4" rx="1.5" fill={isDarkMode ? '#334155' : '#e2e8f0'} />
      </G>

      {/* === Clock (Foreground-center) === */}
      <G transform="translate(58, 20)">
        <Circle cx="26" cy="26" r="25" fill={isDarkMode ? '#1E293B' : '#ffffff'} stroke={isDarkMode ? '#334155' : '#c7d2fe'} strokeWidth="1.5" />
      ...
      <G transform="translate(92, 48)">
        <Circle cx="14" cy="14" r="14" fill={isDarkMode ? '#1E293B' : '#ffffff'} stroke={isDarkMode ? '#065F46' : '#a7f3d0'} strokeWidth="1" />
      ...
      <G transform="translate(18, 76)" opacity="0.8">
        ...
        <Path d="M3 -3 Q4 -6 3 -9 M7 -3 Q8 -6 7 -9" stroke={isDarkMode ? '#64748B' : '#94a3b8'} strokeWidth="0.8" fill="none" opacity="0.5" />
      </G>

      {/* Decorative stars / ticks */}
      <Path d="M105 15 L108 18 L105 21 L102 18 Z" fill="#fbbf24" opacity="0.7" />
      <Circle cx="16" cy="22" r="1.5" fill={isDarkMode ? '#818CF8' : '#6366f1'} opacity="0.3" />
