...
export default function ReportIllustration({
  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 150 110">
      ...
      <Circle cx="30" cy="40" r="22" fill="#e0f2fe" opacity="0.5" />
      <Circle cx="120" cy="70" r="20" fill="#f3e8ff" opacity="0.6" />

      {/* Shadow */}
      <Ellipse cx="75" cy="98" rx="55" ry="5" fill="#6366f1" opacity="0.08" />
      ...
      <Circle cx="25" cy="78" r="4" fill="#ffffff" stroke="#6366f1" strokeWidth="2" />
      <Circle cx="45" cy="62" r="4" fill="#ffffff" stroke="#6366f1" strokeWidth="2" />
      <Circle cx="65" cy="48" r="4" fill="#ffffff" stroke="#6366f1" strokeWidth="2" />
      <Circle cx="85" cy="54" r="4" fill="#ffffff" stroke="#6366f1" strokeWidth="2" />
      <Circle cx="105" cy="28" r="4" fill="#ffffff" stroke="#6366f1" strokeWidth="2" />
      <Circle cx="125" cy="36" r="4" fill="#ffffff" stroke="#6366f1" strokeWidth="2" />

      {/* === Magnifying Glass / Insight tool === */}
      <G transform="translate(90, 48)">
        <Circle cx="12" cy="12" r="8" fill="#ffffff" stroke="#6366f1" strokeWidth="2" />
      ...
      <Circle cx="130" cy="22" r="1.5" fill="#6366f1" opacity="0.3" />
