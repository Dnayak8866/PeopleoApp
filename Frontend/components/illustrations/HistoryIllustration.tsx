...
export default function HistoryIllustration({
  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 150 110">
      ...
      <Circle cx="30" cy="35" r="18" fill="#e0f2fe" opacity="0.6" />
      <Circle cx="120" cy="75" r="22" fill="#ede9fe" opacity="0.5" />
      ...
      <G transform="translate(30, 20)">
        <Rect x="0" y="0" width="90" height="65" rx="10" fill="#ffffff" stroke="#c7d2fe" strokeWidth="1.5" />
        ...
        <Rect x="72" y="24" width="10" height="10" rx="2" fill="#e2e8f0" />

        {/* Row 2 */}
        <Rect x="8" y="38" width="10" height="10" rx="2" fill="#e2e8f0" />
        ...
        <Rect x="24" y="52" width="10" height="10" rx="2" fill="#e2e8f0" />
        <Rect x="40" y="52" width="10" height="10" rx="2" fill="#e2e8f0" />
      ...
      <Circle cx="12" cy="30" r="1.5" fill="#6366f1" opacity="0.3" />
